...
const navigationItems = [
  ...
  { label: 'Forecast', href: '#forecast-focus' },
  { label: 'Lab', href: '#modeling-lab' },
    ...
    <div className="app-shell">
      <header className="border-bottom bg-white sticky-top shadow-sm">
        <nav className="navbar navbar-expand-md py-3">
          <div className="container d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3">
            ...
            <div className="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3 ms-md-auto w-100">
              <ul className="navbar-nav flex-row flex-wrap gap-1 gap-md-2">
                {navigationItems.map((item) => (
                  <li key={item.href} className="nav-item">
                    <a className="nav-link px-2 px-md-3" href={item.href}>
                      {item.label}
                    </a>
                  </li>
                ))}
              </ul>
              <a className="btn btn-primary rounded-pill px-4" href="#roadmap">
                View Plan
              </a>
            </div>
          </div>
